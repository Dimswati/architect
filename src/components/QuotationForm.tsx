...
const QuotationForm = () => {
    ...
    const { register, formState: { errors } } = useForm<QuotationFormValues>({
        defaultValues: {
  ...
  return (
    <Form method="post" className="flex flex-col gap-y-4 p-5 border-2 border-neutral-200" noValidate>
